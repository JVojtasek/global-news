...
STRINGS = {
    "en": {
        ...
        "brief_page_intro": "Your country at a glance, then the wider world, what could change your day and one calm step that makes a household more resilient. A finite edition—not an endless feed.",
        ...
        "brief_local_help": "Local reporting and official information for the country saved on this device. Choose it in briefing settings to make this section yours.",
        ...
        "brief_preferences": "Briefing settings",
        "brief_global_label": "Worldwide overview",
...
Write to {email}. We answer.""",
        ...
        "nl_daily_help": "The five-minute briefing.",
        "nl_weekly": "Saturdays",
        "nl_weekly_help": "One edition a week.",
    ...
    "cs": {
        ...
        "brief_page_intro": "Nejdřív vaše země, potom širší svět, co může změnit váš den a jeden klidný krok k odolnější domácnosti. Konečné vydání, ne nekonečný proud.",
        ...
        "brief_local_help": "Místní zpravodajství a oficiální informace pro zemi uloženou v tomto zařízení. Vyberte ji v nastavení briefingu a tahle část bude vaše.",
        ...
        "brief_preferences": "Nastavení briefingu",
        "brief_global_label": "Celosvětový přehled",
...
Pište na {email}. Odpovídáme.""",
        ...
        "nl_weekly": "V sobotu",
        "nl_weekly_help": "Jedno vydání týdně.",
