...
event_id: ''
image_query: old leather-bound books in a quiet archive conservation shelf
sources:
- name: Analytical Chemistry — Material Degradomics, On the Smell of Old Books
  url: https://www.researchgate.net/publication/26818853_Material_Degradomics_On_the_Smell_of_Old_Books
  published: '2009-09-17'
- name: The Children's Museum of Indianapolis — Why Do Old Books Smell Old?
  url: https://www.childrensmuseum.org/stories/why-old-books-smell-old
  published: '2020-02-01'
- name: Canadian Conservation Institute — Basic Care of Books
...
tickers: []
quiz:
  question: What does the characteristic smell of an old book most directly indicate?
  options:
  - Volatile compounds are being released as several book materials change over time.
...
1. Check for visible mould, tide lines, powdering leather, loose pages and distorted covers.
2. Move books away from radiators, direct sunlight, plumbing, damp basements and overheated attics.
3. Store ordinary volumes upright with support; place unusually large books flat without tall stacks.
4. Do not force a tight binding open or repair a historic volume with household tape.
5. Isolate a book with suspected active mould and seek qualified conservation advice rather than brushing it indoors.
