...
format: wider-lens
event_id: evergreen-ernst-chladni-nodal-patterns
series: ''
image_query: Chladni plate sand geometric nodal patterns physics demonstration
sources:
- name: Kenyon College Physics — Chladni Plates
  url: https://physics.kenyon.edu/EarlyApparatus/Acoustics/Chladni/Chladni.html
  published: ''
- name: University of Toronto Experimental Nonlinear Physics Group — Chladni patterns
  url: https://www.physics.utoronto.ca/nonlinear/chladni.html
  published: ''
- name: Bartosz Ciechanowski — Sound
  url: https://ciechanow.ski/sound/
  published: '2022-10-18'
- name: arXiv — Thermodynamics of bouncing grains
  url: https://arxiv.org/abs/2606.05930
  published: '2026-06-04'
qma_path: ''
tickers: []
quiz:
  question: Why does sand collect in the lines of a Chladni figure?
  options:
  - Those lines are the hottest parts of the plate.
