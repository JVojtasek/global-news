...
event_id: ''
series: ''
image_query: medicine bottles paper checklist calm clinical still life
sources:
- name: WHO — Medication Safety in Transitions of Care
  url: https://www.who.int/publications/i/item/WHO-UHC-SDS-2019.9
  published: '2019-06-20'
- name: AHRQ — Conduct Brown Bag Medicine Reviews
  url: https://www.ahrq.gov/health-literacy/improve/precautions/tool8.html
...
- name: AHRQ PSNet — Medication Reconciliation
...
1. Gather every prescription, over-the-counter product, vitamin, supplement, inhaler, cream, drop, injection and patch you currently use.
2. Write the exact name, strength, actual dose, timing, route and purpose. Mark anything taken differently from its label.
3. Add allergies, significant reactions, an emergency contact and the date you checked the list.
4. Photograph the list and containers, or bring the containers in a bag if the clinic permits.
5. Ask the clinician or pharmacist to resolve duplicates, missing items and unclear instructions. Do not change treatment until that conversation occurs.
