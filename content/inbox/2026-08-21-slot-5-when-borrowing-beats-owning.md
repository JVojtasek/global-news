...
- title: Our year in review 2023
  ...
  source_type: operator impact report; self-reported
  url: https://participate.libraryofthings.co.uk/impact-report-2023
- title: 'How we calculate our impact: 2024 update'
  publisher: Library of Things
  published_at: '2024-02-02'
  source_type: operator methodology disclosure
  url: https://www.libraryofthings.co.uk/blog/how-we-calculate-our-impact-2024-update
- title: Library of Things has Positive Social and Environmental Impacts
  publisher: LAB University of Applied Sciences
  published_at: '2021-12-02'
  source_type: independent field-study summary
  url: https://blogit.lab.fi/labfocus/en/library-of-things-has-positive-social-and-environmental-impacts/
- title: Circular economy
  publisher: European Environment Agency
  published_at: '2026-05-20'
  source_type: official evidence and policy overview
  url: https://www.eea.europa.eu/en/topics/in-depth/circular-economy
qma_path: ''
tickers: []
quiz:
  question: When is borrowing an item most likely to reduce its environmental burden?
  options:
  - Whenever the loan is free
...
1. **How often will I really use it?** If the honest answer is once or twice a year, borrowing deserves a look. If delay would create serious harm or expense, ownership may be justified.
2. **What is the true round trip?** Include fares, fuel, time, collection hours and the chance of a second journey if something is missing.
3. **Who maintains the item and what happens if it breaks?** Read the deposit, cleaning, consumables, late-return and damage terms before reserving it.
4. **Will this loan replace a purchase?** If not, do not count an avoided product that was never going to exist.
