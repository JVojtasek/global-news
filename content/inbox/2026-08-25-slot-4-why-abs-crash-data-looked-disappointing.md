...
Then researchers looked at real crashes. The early totals were not the clean victory that the laboratory mechanism seemed to promise. Some collision types fell; some run-off-road crashes rose. The puzzle was not that ABS did nothing. It was that a device can work exactly as designed and still meet a world messier than the test track.
