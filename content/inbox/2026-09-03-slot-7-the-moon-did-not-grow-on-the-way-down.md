...
- name: IBM Research and PNAS — Explaining the moon illusion
  url: https://research.ibm.com/publications/explaining-the-moon-illusion
  published: '2000-01-04'
- name: Live Science — Why the Moon looks larger on the horizon
  url: https://www.livescience.com/space/the-moon/why-does-the-moon-look-larger-when-its-on-the-horizon
...
1. Take a fixed-zoom photograph with the disk near a landmark.
2. Note how large it feels before looking at the image.
3. Later, photograph it higher in the sky without changing zoom.
4. Crop both frames to the same scale and compare the disk in pixels.
