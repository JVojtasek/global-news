...
title: 'Jestřábí výrok nestačí: kdy se skutečně promítne do výnosů a firemních investic
  — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: Jeden jestřábí výrok není nový kurz Fedu; význam má až
  tehdy, když se propíše do výnosů, kreditních spreadů a firemních plánů investic.'
section: business
type: imported
depth: open
lang: cs
...
status: published
confidence: 0
image_query: 'Jestřábí výrok nestačí: kdy se'
origin:
  name: QMA
