...
title: 'Co znamená domov pro lidi, které nespojuje žádné jedno území?'
dek: 'V tomto společném textu se přispěvatelé Global Voices věnují dvěma příběhům lidí bez státní příslušnosti a ukazují, jak menšiny v regionu znovu promýšlejí, co je národ, loajalita a identita'
section: world
type: syndicated
depth: open
lang: cs
