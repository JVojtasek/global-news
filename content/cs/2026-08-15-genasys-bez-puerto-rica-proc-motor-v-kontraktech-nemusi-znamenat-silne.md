...
title: 'Genasys bez Puerto Rica: proč „motor“ v kontraktech nemusí znamenat silné
  jádro — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: U projektových technologických firem nestačí sledovat tržby:
  klíčové je, zda se faktury mění na hotovost a zda jeden velký kontrakt nezakrývá
  slabé jádro b'
section: business
type: imported
depth: open
...
status: published
confidence: 0
image_query: 'Genasys bez Puerto Rica: proč'
origin:
  name: QMA
