---
slug: pokles-vynosu-breakeven-inflace-a-pohyb-jenu-uleva-nebo-utek-pred-rizi
title: 'Pokles výnosů, breakeven inflace a pohyb jenu: úleva, nebo útěk před rizikem?
  — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: Pokles výnosů čtěte přes breakeven inflaci, reálné výnosy,
  kreditní spready a pohyb jenu — stejný pokles může znamenat úlevu od inflace, nebo
  útěk před riz'
section: business
type: imported
depth: open
