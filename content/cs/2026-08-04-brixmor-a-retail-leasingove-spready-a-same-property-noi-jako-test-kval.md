---
slug: brixmor-a-retail-leasingove-spready-a-same-property-noi-jako-test-kval
title: 'Brixmor a retail: leasingové spready a same-property NOI jako test kvality
  — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: U retailových REITů sledujte méně slogan o dividendě a
  více tvrdou kombinaci leasingových spreadů, same-property NOI, obsazenosti, podepsaného
  budoucího ná'
section: business
type: imported
depth: open
