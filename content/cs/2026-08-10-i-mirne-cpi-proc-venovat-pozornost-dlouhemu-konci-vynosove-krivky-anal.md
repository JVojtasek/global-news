...
title: 'I mírné CPI: proč věnovat pozornost dlouhému konci výnosové křivky — Analýza
  QMA Brain'
dek: 'Analýza QMA Brain 🤖: U mírného CPI sledujte hlavně dlouhý konec výnosové křivky
  jako analytický ukazatel rizika: pokud výnosy rostou i bez inflačního šoku, problémem
  může být d'
section: business
type: imported
depth: open
...
status: published
confidence: 100
image_query: 'I mírné CPI: proč věnovat'
origin:
  name: QMA
