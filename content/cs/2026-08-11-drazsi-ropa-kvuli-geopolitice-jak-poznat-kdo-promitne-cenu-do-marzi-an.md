...
title: 'Dražší ropa kvůli geopolitice: jak poznat, kdo promítne cenu do marží — Analýza
  QMA Brain'
dek: 'Analýza QMA Brain 🤖: Dražší ropa kvůli geopolitice není jednoduchá sázka na
  energetiku; klíčové je, kdo umí vyšší náklad přenést dál a komu se zakousne do marží.'
section: business
type: imported
depth: open
lang: cs
