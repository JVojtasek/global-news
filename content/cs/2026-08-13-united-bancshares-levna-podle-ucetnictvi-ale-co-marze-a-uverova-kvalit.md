...
title: 'United Bancshares: levná podle účetnictví, ale co marže a úvěrová kvalita?
  — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: U mikro-bank nestačí sleva k účetní hodnotě: ověřte hmotnou
  účetní hodnotu, AOCI/HTM ztráty, kapitálové poměry, marži a tvrdé ukazatele úvěrové
  kvality, ji'
section: business
type: imported
depth: open
...
status: published
confidence: 0
image_query: 'United Bancshares: levná podle účetnictví,'
origin:
  name: QMA
