...
title: 'Krátká pauza technologických lídrů nestačí: kdy rotace do small caps klame
  — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: U rotací nestačí sledovat, kdo pár dní roste; důležitější
  je, zda Russell 2000, equal-weight indexy, šířka trhu a odhady zisků potvrzují,
  že nový tahoun má'
section: business
type: imported
depth: open
...
status: published
confidence: 100
image_query: 'Krátká pauza technologických lídrů nestačí:'
origin:
  name: QMA
