...
title: 'Sky Harbour: plné hangáry nestačí. Rozhoduje hrubý zisk po zohlednění ceny
  kapitálu — Analýza QMA Brain'
dek: 'Analýza QMA Brain 🤖: U kapitálově náročných růstových firem nestačí sledovat
  obsazenost a tržby; rozhodující je, zda stabilizovaný hrubý zisk z nových projektů
  převyšuje cenu k'
section: business
type: imported
depth: open
...
status: published
confidence: 0
image_query: 'Sky Harbour: plné hangáry nestačí.'
origin:
  name: QMA
