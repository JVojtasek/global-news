...
title: Why the Spokane wildfires became so catastrophic
dek: Extreme fire conditions converged in suburban neighborhoods built into the forests,
  shrubland and grasslands and quickly spread.
section: science
type: syndicated
depth: open
lang: en
...
status: published
confidence: 100
image_query: Why the Spokane wildfires became so
syndicated:
  source: The Conversation — Environment
  author: John Abatzoglou, Professor of Engineering, University of California, Merced
  url: https://theconversation.com/why-the-spokane-wildfires-became-so-catastrophic-288895
  license: CC BY-ND 4.0
  license_url: https://creativecommons.org/licenses/by-nd/4.0/
  attribution: By John Abatzoglou, Professor of Engineering, University of California,
    Merced. This article is republished from <a href="https://theconversation.com">The
    Conversation</a> under a Creative Commons licence. <a href="https://theconversation.com/why-the-spokane-wildfires-became-so-catastrophic-288895">Read
...
impact:
  areas: [safety, life]
  line: >-
    For anyone whose home sits where houses meet forest, shrubland or
    grassland: the fire scientists say keep the five feet (about 1.5 metres)
    nearest the house, known as Zone 0, free of anything that burns, and
    harden roofs, windows and openings against wind-blown embers.
  todo: >-
    Watch for escalated fire warnings — Spokane had a rare “particularly
    dangerous situation” alert one day before — and ask whether your community
    has a wildfire protection plan.
---

Three large wildfires raced through neighborhoods in and around Spokane, Washington, starting the weekend of Aug. 1, 2026, destroying more than 800 homes and other structures and threatening many more . Tens of thousands of people, including patients at a Veterans Affairs medical center, were forced to evacuate as the fires spread.

The origins of the fires were under investigation, though authorities arrested a man on Aug. 3 on suspicion of arson in connection with one of them.

Residents knew they faced a high risk that any fires that did start that weekend could quickly spread. One day before the fires broke out, the National Weather Service declared a rare “ particularly dangerous situation” warning for the Spokane region, the first of its kind in Washington state.
...
Forecasters had reason to be concerned. In Spokane, dry, windy conditions converged in what’s known as the wildland-urban interface – an area where neighborhoods have been built into the forests, shrublands and grasslands. That set the stage for the latest wildland-urban disaster in the U.S.

### What causes extreme fire behavior?

The fast spread of the Spokane fires, collectively known as the Spokane Complex Fire, resulted from a convergence of compounding factors, including drought, plenty of fuel and strong winds.
...
Despite generally dry conditions, spring rain, interspersed with periods of above-average temperatures, supported widespread growth of grasses, shrubs and other vegetation across the Northwest. Exposed to scorching summer temperatures, this vegetation dried quickly and became highly flammable, leaving a continuous fuel bed where wildfires could ignite and rapidly spread.
...
Across the U.S., more than 45,000 wildfires had burned more than 5.5 million acres in 2026 as of Aug. 6, well above the 10-year average for that point in the year. That included blazes in June raging in difficult terrain along the Utah–Colorado border that claimed the lives of four firefighters , and escalating fire activity that followed across the Northwest as summer progressed.

### What’s different about the Spokane fires?
...
That environment created dangerous pathways for fire to spread into developed areas, ignite vulnerable structures and then propagate from one structure to the next. By Aug. 6, the Spokane fires had burned more than 10,400 acres , over 16 square miles (41 square kilometers), and were still burning.

### Destructive Spokane fires reflect a broader trend
...
### How everyone can reduce fire risk
...
This article, originally published Aug. 3, 2026, has been updated with more buildings burning.
...
<img src="https://counter.theconversation.com/content/288895/count.gif" alt="" width="1" height="1">
