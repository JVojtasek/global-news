...
format: ''
event_id: virginia-apgar-1953-newborn-score-standard-observation
series: ''
image_query: Virginia Apgar physician newborn assessment historical hospital photograph
sources:
- name: U.S. National Library of Medicine — Biography of Dr Virginia Apgar
  url: https://www.nlm.nih.gov/exhibition/changing-the-face-of-medicine/physicians/biography_virginia_apgar.html?id=item-13
  published: ''
...
- name: NCBI Bookshelf — APGAR Score
  url: https://www.ncbi.nlm.nih.gov/books/NBK470569/
  published: '2024-02-12'
qma_path: ''
tickers: []
quiz:
  question: What is the best description of an Apgar score?
  options:
  - A snapshot for reporting a newborn's condition and response shortly after birth.
