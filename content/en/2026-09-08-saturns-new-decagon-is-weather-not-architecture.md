...
The [NASA Hubble team](https://science.nasa.gov/missions/hubble/nasas-hubble-tracks-new-decagon-encircling-saturns-south-pole/) says this is the first large, regular-sided jet pattern observed in Saturn’s southern hemisphere. It appeared in Hubble images taken through the Outer Planet Atmospheres Legacy program, or OPAL, which has photographed the outer planets annually for more than a decade.
...
The pattern sits near 63 degrees south latitude. Different filters, which sample different heights in Saturn’s atmosphere, show that it is vertically extended rather than painted onto one cloud deck. [UC Berkeley’s Space Sciences Laboratory](https://www.ssl.berkeley.edu/decagon-wave-emerges-near-saturns-south-pole/) reports winds associated with the jet at roughly 400 kilometres per hour.
...
The [ESA/Hubble release](https://esahubble.org/news/heic2612/) is explicit about what remains unknown: how the decagon formed, how long it will last and how it compares with the northern hexagon. The aerosol particles that give the region its blue colour are also not yet identified.
...
Finally, it is possible that the feature is not new at all, only newly visible. [Science News](https://www.sciencenews.org/article/hubble-decagon-saturn-south-pole) explains the observational gap: Cassini ended its mission in 2017, and Saturn’s south pole had been turning away from Earth since 2012 before returning to view in 2023. The available record supports “recently emerged,” but cannot supply a precise birthday.
