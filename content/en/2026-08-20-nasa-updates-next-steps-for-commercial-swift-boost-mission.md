...
dek: Due to an ongoing commercial spacecraft attitude control issue, NASA and Katalyst
  Space announced Wednesday the LINK spacecraft will not capture or boost an agency
  satellite to a higher altitude to ex
section: science
type: syndicated
depth: open
lang: en
...
status: published
confidence: 0
image_query: NASA Updates Next Steps for Commercial
syndicated:
  source: NASA
  author: Lauren E. Low
  ...
  attribution: Originally published by <a href="https://www.nasa.gov/news-release/nasa-updates-next-steps-for-commercial-swift-boost-mission/">NASA</a>.
...
Alise Fisher Headquarters, Washington 202-358-2546 alise.m.fisher@nasa.gov
