...
dek: 'How do scientists studying space with data from a telescope hundreds of thousands
  of miles away know that what they are seeing is real? A new NASA project, Artifact
  InSPECtor, invites you to find out '
section: science
type: syndicated
depth: open
lang: en
...
status: published
confidence: 0
image_query: Help Refine Data from Space Telescopes
syndicated:
  source: NASA
  ...
  attribution: Originally published by <a href="https://science.nasa.gov/get-involved/citizen-science/help-refine-data-from-space-telescopes-with-artifact-inspector/">NASA</a>.
