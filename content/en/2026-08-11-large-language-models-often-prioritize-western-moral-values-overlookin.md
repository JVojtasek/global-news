---
slug: large-language-models-often-prioritize-western-moral-values-overlookin
title: Large language models often prioritize Western moral values, overlooking other
  cultures
dek: Generative AI’s overemphasis on Western moral concerns could reinforce global
  disparities in sensitive applications such as public health messaging and global
  communication.
section: questions
type: syndicated
depth: open
...
status: published
confidence: 100
image_query: Large language models often prioritize Western
syndicated:
  source: The Conversation — Ethics & Big Questions
  author: Alexandra Figueroa, Postdoctoral Scholar, University of California, Berkeley
  ...
  attribution: By Alexandra Figueroa, Postdoctoral Scholar, University of California,
    Berkeley. This article is republished from <a href="https://theconversation.com">The
    Conversation</a> under a Creative Commons licence. <a href="https://theconversation.com/large-language-models-often-prioritize-western-moral-values-overlooking-other-cultures-285660">Read
...
Aliah Zewail receives funding from the National Science Foundation Graduate Research Fellowship Program.

Alexandra Figueroa does not work for, consult, own shares in or receive funding from any company or organization that would benefit from this article, and has disclosed no relevant affiliations beyond their academic appointment.

<img src="https://counter.theconversation.com/content/285660/count.gif" alt="" width="1" height="1">
