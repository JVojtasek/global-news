...
section: travel
depth: open
slug: eu-entry-exit-system-no-stamps
title: Nobody Stamps Your Passport at the EU Border Any More. A Database Now Counts
...
event_id: ''
series: ''
image_query: airport border control passport gate Europe
sources:
- name: European Commission, Migration and Home Affairs - Entry/Exit System
  url: https://home-affairs.ec.europa.eu/policies/schengen-borders-and-visa/smart-borders/entry-exit-system_en
  published: '2026'
- name: eu-LISA - quarterly report on the Entry/Exit System, 1 January to 31 March
    2026
  url: https://www.eulisa.europa.eu/
  published: '2026'
- name: European Union - Travel to Europe, official traveller information on the EES
  url: https://travel-europe.europa.eu/ees_en
  published: '2026'
- name: European Commission - ETIAS, the travel authorisation that pairs with the
    Entry/Exit System
  url: https://travel-europe.europa.eu/etias_en
  published: '2026'
- name: Regulation (EU) 2017/2226 establishing the Entry/Exit System, consolidated
    text
  url: https://eur-lex.europa.eu/eli/reg/2017/2226/oj
  published: '2017-11-30'
quiz:
  question: What changed for travellers on 10 April 2026?
  options:
  - The 90-day limit for short stays was shortened
  - Passport stamping was replaced by a biometric record, but the 90/180 rule itself
    is unchanged
  - Non-EU travellers now need a visa for short stays
  answer: 1
  explanation: The Entry/Exit System replaces the stamp and calculates stays automatically.
    The underlying rule — 90 days in any rolling 180 — was not altered by it.
impact:
  areas:
  - life
  - safety
  line: If you hold a non-EU passport and travel to the Schengen area for short stays,
