---
slug: genasys-bez-puerto-rica-proc-motor-v-kontraktech-nemusi-znamenat-silne
title: 'Genasys without Puerto Rico: why an "engine" contract doesn''t mean a strong
  core — QMA Brain analysis'
dek: 'QMA Brain analysis: For project-based tech companies, revenue alone isn''t
  enough — what matters is whether invoices turn into cash, and whether one big contract
  is masking a'
section: business
type: imported
depth: open
...
status: published
confidence: 0
image_query: emergency alert technology equipment
origin:
  name: QMA
