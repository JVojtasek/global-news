...
section: wonder
depth: open
slug: earth-rotation-babylonian-eclipses
title: The Day Is Getting Longer by 1.78 Milliseconds a Century. Broken Clay Tablets
  Are How We Know.
dek: Scribes in Babylon timed eclipses against a water clock and pressed the results
  into clay. Twenty-seven centuries of such records show the Earth slowing down -
  and slowing rather less than the tides say it should.
confidence: 92
load: 0
topics: []
...
event_id: ''
series: ''
image_query: Babylonian astronomical diaries
sources:
- name: F. R. Stephenson, L. V. Morrison and C. Y. Hohenkerk - Measurement of the
    Earth's rotation, 720 BC to AD 2015, Proceedings of the Royal Society A, volume
    472, article 20160404 (open access)
  url: https://pmc.ncbi.nlm.nih.gov/articles/PMC5247521/
  published: '2016-12-07'
- name: HM Nautical Almanac Office - summary of the Royal Society paper on the Earth's
    rotation
  url: https://astro.ukho.gov.uk/nao/RS_paper.html
  published: '2016'
- name: NASA Jet Propulsion Laboratory - The Apollo Experiment That Keeps on Giving
    (lunar laser ranging)
  url: https://www.jpl.nasa.gov/news/the-apollo-experiment-that-keeps-on-giving/
  published: '2019-07-24'
- name: American Geophysical Union - Ancient shell shows days were half-hour shorter
    70 million years ago, on de Winter and colleagues, Paleoceanography and Paleoclimatology,
    doi 10.1029/2019PA003723
  url: https://news.agu.org/press-release/ancient-shell-shows-days-were-half-hour-shorter-70-million-years-ago/
  published: '2020-03-09'
- name: National Institute of Standards and Technology - Leap seconds frequently asked
    questions
  url: https://www.nist.gov/pml/time-and-frequency-division/leap-seconds-faqs
  published: '2026'
- name: National Institute of Standards and Technology - Time and Frequency Bulletin,
    NIST IR 8529-08
  url: https://nvlpubs.nist.gov/nistpubs/ir/2024/NIST.IR.8529-08.pdf
  published: '2024'
- name: International Earth Rotation and Reference Systems Service - The Earth Orientation
    Parameters
  url: https://www.iers.org/IERS/EN/Science/EarthRotation/EOP.html
  published: '2026'
- name: Hayakawa and colleagues - Earliest datable records of aurora-like phenomena
    in the astronomical diaries from Babylonia, Earth, Planets and Space, volume 68,
    article 195 (open access)
  url: https://link.springer.com/article/10.1186/s40623-016-0571-5
...
impact:
  areas:
  - life
  line: The Earth's spin is slowing by about 1.78 milliseconds per century, measured
    from eclipse records reaching back to 720 BC. Civil clocks are held in step with
    it by leap seconds, so atomic time and everyday time differ by whole seconds.
  todo: Look up the Earth orientation parameters from the International Earth Rotation
    and Reference Systems Service. One of them, length of day, is how much yesterday
    ran long.
---
