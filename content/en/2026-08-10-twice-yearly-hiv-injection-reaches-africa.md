...
title: 'Two injections a year: the HIV shot has started arriving, and the hard part is the queue'
dek: 'Nine African countries have now given 191,620 doses of lenacapavir — a drug that stops HIV by jamming the virus''s protein shell — but supply, not science, is the limit.'
section: goodnews
type: news
depth: open
lang: en
