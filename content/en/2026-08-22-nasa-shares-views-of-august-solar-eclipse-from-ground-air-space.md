...
dek: On Aug. 12, a total solar eclipse darkened skies over Greenland, Iceland, and
  Spain. As the Moon covered the Sun, it briefly revealed the Sun’s wispy outer atmosphere
  — the corona — to those in the pa
section: science
type: syndicated
depth: open
lang: en
...
status: published
confidence: 0
image_query: NASA Shares Views of August Solar
syndicated:
  source: NASA
  ...
  attribution: Originally published by <a href="https://science.nasa.gov/science-research/heliophysics/nasa-shares-views-of-august-solar-eclipse-from-ground-air-space/">NASA</a>.
