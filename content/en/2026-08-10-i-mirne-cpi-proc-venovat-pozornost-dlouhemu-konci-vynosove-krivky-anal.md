---
slug: i-mirne-cpi-proc-venovat-pozornost-dlouhemu-konci-vynosove-krivky-anal
title: 'Even a Mild CPI: Why the Long End of the Yield Curve Deserves Attention —
  QMA Brain Analysis'
dek: 'QMA Brain Analysis: With a mild CPI print, watch mainly the long end of the
  yield curve as an analytical risk gauge — if yields rise even without an inflation
  shock, the problem may be the cost of time, not inflation itself.'
section: business
type: imported
depth: open
lang: en
...
status: published
confidence: 100
image_query: bond yield curve chart
origin:
  name: QMA
...
- Is the long-bond yield rising because of inflation, or because of higher real yields? Real yield is the yield after subtracting inflation expectations.

- Is the curve steepening through the long end? That points more toward a term premium and uncertainty, not necessarily a hot CPI.

- For growth stocks, watch: free cash flow, debt refinancing, and whether the valuation rests on earnings many years out.

- Red flag: a company with negative free cash flow, near-term debt maturities, and a valuation built on optimistic growth.
